...
<div style="padding: 10rem;">
  ...
  <p>{{eventData.host}}</p>
   ...
   <p>参加条件</p>
   <input type="checkbox" id="10" value="10代"v-model="eventData.taeget">
   <label for="10">10代</label>
    <input type="checkbox" id="20" value="20代"v-model="eventData.taeget">
   <label for="20">20代</label>
    <input type="checkbox" id="30" value="30代"v-model="eventData.taeget">
   <label for="30">30代</label>
   <p>{{ eventData.taeget }}</p>
